...
app.get('/forgot', externalUser.getForgot)
app.post('/forgot', externalUser.postForgot)
app.get('/reset/:token', externalUser.getReset)
app.post('/reset/:token', externalUser.postReset)
app.get('/signup', externalUser.getSignup)
app.post('/signup', externalUser.postSignup)
