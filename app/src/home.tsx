...
type props = types.message & types.myCourses & actionProps;
      ...
      <div className="text-center">
        ...
        <div className="home-container-1">
          <div className="home-child-1">
            <img src={icon as string} style={{ height: "200px" }} />
            <h1>Welcome to the Ethics Training Program</h1>
            <h3>
              This annual program is <b>mandatory</b> for all employees of the
              City of Pittsburgh
            </h3>
            <Messages />
          </div>
        ...
        <div className="home-container-1">
          <div className="home-child-1">
            <h1 ref={this.ref} style={{ marginTop: "100px" }}>
              <b>Step 2:</b>
              <br />
              Complete the exam
            </h1>
            <h4>
              The exam is comprised of three modules and can be saved to be
              completed at a later time
            </h4>
            {onExam == false && (
              <button
                style={{ marginBottom: "100px" }}
                onClick={this.openExam.bind(this)}
                className="btn btn-primary"
              >
                <span style={{ fontSize: "1.5em" }}>
                  {openExam ? "Continue the exam" : "Take the exam"}
                </span>
              </button>
            )}
            {onExam == true && (
